...
public class GameResources {
    ...
    public static final String LIVE_IMG_PATH = "textures/star.png";

    public static final String TORPEDO_IMG_PATH = "textures/torpedo.png";
    public static final String SUB_IMG_PATH = "textures/sub.png";
    ...
    public static final String BLAST_SOUND_PATH = "sounds/blast.mp3";
    public static final String SHOOT_SOUND_PATH = "sounds/shot.mp3";

    // Fonts for text

    public static final String FONT_PATH = "fonts/luckie.otf";
