...
public class SubmarineObj extends GameObj {
    ...
    public SubmarineObj(int x, int y, int width, int height, String texturePath, World world) {
        super(texturePath, x, y, width, height, GameSettings.SUB_BIT, world);
    ...
    public void move(Vector3 vector3) {
        body.applyForceToCenter(new Vector2(
                        (vector3.x - getX()) * GameSettings.SUB_FORCE_RATIO,
                        (vector3.y - getY()) * GameSettings.SUB_FORCE_RATIO),
                true
        );
    }
